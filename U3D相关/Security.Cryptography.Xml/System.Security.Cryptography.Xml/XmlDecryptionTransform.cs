...
public class XmlDecryptionTransform : Transform
{
	...
	private ArrayList ExceptUris => _arrayListUri ?? (_arrayListUri = new ArrayList());
	...
	public override void LoadInnerXml(XmlNodeList nodeList)
	{
		...
		foreach (XmlNode node in nodeList)
		{
			if (node is XmlElement xmlElement)
			{
				...
				{
					throw new CryptographicException(System.SR.Cryptography_Xml_UriRequired);
				}
	...
	private void LoadStreamInput(Stream stream)
	{
		...
		XmlResolver xmlResolver = (base.ResolverSet ? _xmlResolver : XmlResolverHelper.GetThrowingResolver());
	...
	private void ProcessElementRecursively(XmlNodeList encryptedDatas)
	{
		...
		while (xmlNode != null)
		{
			if (xmlNode is XmlElement { LocalName: "EncryptedData", NamespaceURI: "http://www.w3.org/2001/04/xmlenc#" } xmlElement)
			{
