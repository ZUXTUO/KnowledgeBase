...
class SevenZipRecovery:
    ...
    def _get_resource_path(self, relative_path: str) -> str:
        """Get resource file path, supporting development environment and PyInstaller packaged environment"""
        try:
    ...
    def _setup_tools(self):
        ...
        # Ensure at least one decompression tool is available
        ...
        try:
            for offset in range(0, min(1024, self.file_size), 4):
                ...
                if self._can_list_archive(temp_file):
                    ...
                    # Removed self._cleanup_temp_file(temp_file) to keep brute_force temp files
                    return True
                else:
    ...
    def repair(self) -> bool:
        ...
        try:
            ...
            # Removed self._cleanup_all_temp_files() to keep processed 7z and temp files
            pass 
        if not success:
            print("所有修复方法均失败")
        return success
