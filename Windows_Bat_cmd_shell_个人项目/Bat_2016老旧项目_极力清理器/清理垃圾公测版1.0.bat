...
if /i '%choice%'=='4' goto shezhi5462

if /i '%choice%'=='5' goto fankuion
...
set choice= 
set /p choice=请输入您的指令：
if /i '%choice%'=='1' goto BGMstartorshut
if /i '%choice%'=='2' goto kaijidonghua523
...
:BGMstartorshut
cls
echo 打开背景音乐输入1，关闭背景音乐2
echo.
echo                                      返回请输入0
set choice= 
set /p choice=请输入您的指令：
if /i '%choice%'=='1' goto startBGMen
if /i '%choice%'=='2' goto shutdownmusic
if /i '%choice%'=='0' goto back1234
...
:kaijidonghua523
cls
echo 开机动画已启动1，开机动画已关闭2
echo.
echo                                      返回请输入0
set choice= 
set /p choice=请输入您的指令：
if /i '%choice%'=='1' goto kaiqidonghua123
if /i '%choice%'=='2' goto guanbidonghua456
if /i '%choice%'=='0' goto back1234
...
:shutdownmusic
cls
taskkill /f /im gplay.exe
taskkill /f /im music.exe
set news=背景音乐已启动！
cls
goto maxice
...
echo Preparing for a second cleanup
